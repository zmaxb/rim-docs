...
Бот связывает демонстрационную модель бота с параметрами интеграции ВКонтакте и создаёт работающий экземпляр для обработки входящих запросов.
...
!!! success "Проверка работы бота выполнена"
    ...
    ![Проверка работы бота ВКонтакте](../img/vk-bot-response.png)
